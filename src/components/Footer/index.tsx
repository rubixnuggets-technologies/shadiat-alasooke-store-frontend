      ...
      <div className="layout">
        <div>
          ...
          <div className="mt-6 lg:mt-10 flex justify-center">
            <div className="border-2 w-full w-full mx-9 lg:w-[600px] h-9 lg:h-12 flex flex-row border-brown-2100">
              <input
          ...
          <ul className="flex flex-col lg:grid lg:grid-cols-6 gap-14 lg:gap-24 content-stretch">
            ...
            <li>
              <div className="flex flex-col gap-4 lg:gap-8">
                ...
                <p className="text-sm lg:text-base">Lagos: +234 803 462 6067</p>
                <p className="text-sm lg:text-base">Abuja: +234 911 401 9172</p>
                <p className="text-sm lg:text-base">info@shadiatalasooke.com</p>
              </div>
            </li>
              ...
              <div>
                ...
                <div className="mt-4 lg:mt-8">
                  <ul className="flex flex-col gap-4 lg:gap-8">
                    ...
                    <li>
                      <Link href="/about">
                        <p className="text-sm lg:text-base"> My Account </p>{" "}
                      </Link>
                    </li>

                    <li>
                      <Link href="/about">
                        <p className="text-sm lg:text-base"> My Cart </p>{" "}
                      </Link>
                    </li>
                  </ul>
                </div>
