    ...
    <div className="h-[248px] lg:h-[850px] relative w-full">
      ...
      >
        <div className="flex flex-col gap-2 w-fit">
          {data?.title && (
            <h1
              className={`text-base text-${data?.text_color || "brown-2100"} lg:text-[40px]`}
            >
              {data?.title}
            </h1>
          )}
          ...
          <div className="hidden lg:flex">
            <Link href={data?.link_url || "#"}>
              <Button color={data?.text_color} width="52" title="Shop Now" />
            </Link>
          </div>
          ...
          <div className="flex lg:hidden">
            <Link href={data?.link_url || "#"}>
              <p
                className={`text-xs underline font-bold text-${data?.text_color || "brown-2100"}`}
              >
                Shop Now
              </p>
            </Link>
