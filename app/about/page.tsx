        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-16 layout">
            <div>
              ...
              <div className="mt-8">
                ...
                <p className="mt-4">
                  In a world rich with culture and heritage, showcasing the
                  beauty and tradition of one's attire is an intentional fashion
            ...
            <div>
              ...
              <div className="mt-8">
                ...
                <p className="mt-4">
                  ...
                  Oke is meticulously handwoven by skilled artisans, ensuring
                  the highest standards of excellence. Our dedication to
                  preserving traditional techniques while incorporating modern
                  designs results in stunning, unique pieces that exude elegance
          ...
          <div className="max-w-[850px] m-auto">
            <div className="mt-36">
              <div className="w-[484px] m-auto" >
                ...
                <p className="mt-4 text-center ">
                  ...
                  (RTW) collections, and bespoke designs tailored to your
                  creative vision.
                </p>
              </div>
            ...
            <div className="mt-36">
              ...
              <p className="mt-4">
                Our commitment to quality and meticulous craftsmanship has set
                us apart in the industry, celebrating the artistry and cultural
